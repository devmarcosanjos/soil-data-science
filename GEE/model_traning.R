...
//var version = 'matriz-collection2_MODEL1_Corumbiara' // Change as needed - Amazônia
//var version = 'collection2-filter-rep-FINAL_MODEL2' // Change as needed - Caatinga, Pantanal, Cerrado e Mata Atlântica
// var version = 'collection2-filter-rep-FINAL_MODEL3' // Change as needed - Pampa
// var version = 'v2-4-9-amazonia' //Change as needed
...
points.aggregate_array('year').distinct().sort().evaluate(function(years){
  ...
  var assetId = 'projects/ee-marcosanjos/assets/DEV/Corumbiara/RandonFlorenst' + version;
  //var assetId = 'projects/ee-marcosanjos/assets/DEV/' + municipio_nome + '/' + 'RandonFlorestModel-' + version;
